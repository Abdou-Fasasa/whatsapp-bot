...
if (!msg.key.remoteJid.endsWith("@g.us")) return; // تجاهل أي رسالة ليست في الجروبات
        ...
        const bannedWords = [
            "كلمة1", "كلمة2", "كلمة3", "ابن ال", "يا ابن", "يلعن", "كسم", "خول", "عرص", "متناك", "قحبة", "شرموط",
            "الوسخة", "الزانية", "زب", "العرص", "الحمار", "حيوان", "حمار", "غبي", "متخلف", "تافه", "منيك", "المنيك",
            "معرص", "منيوك", "شرموطة", "وسخة", "زانية", "كحبة", "الواطي", "حقير", "ديوث", "النذل", "سافل", "ساقط",
            "نجس", "زفت", "غدار", "مخنث", "قذر", "زبالة", "متوسخ", "عاهر", "نجس", "ملعون", "قذر", "فاجر", "كلب",
            "ابن الكلب", "خنزير", "فاسق", "تيس", "حمار أهلك", "عديم الشرف", "واطي", "ديوث", "عاهره", "سافلة", "مخنث",
            "متسخ", "قذر", "متنجس", "أنجس خلق الله", "عديم الرجولة", "ممسوخ", "تافهة", "حيوانة", "بهيمة", "زاني", "مخادع" ,"غبى" ,"حماااار"
        ];
